...
const { LIB_DIR, RESULTS_PATH } = require("../paths");

const prevBuildResults = fs.existsSync(RESULTS_PATH)
...
function saveResults() {
  fs.writeFileSync(RESULTS_PATH, JSON.stringify(currentBuildResults, null, 2));
}
